<?php $__env->startSection('content'); ?>
					...
					<div class="inner-body">
						...
						<div class="header">
							<div class="row">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="text">
										<label class="id">Tender ID:#<?php echo e($data['quotation']->tendor->id); ?></label>
									</div>
								</div>
							</div>
						</div><!--END header-->
						...
						<div class="tender-details quatation-details my-orders">
							...
							<div class="product-details">
								...
								<div class="img-text clearfix">
									<div class="img">
										<img onerror="profileImgError(this)" src="<?php echo e($data['quotation']->tendor->user->profile_image); ?>">
									</div>
									<div class="txt">
										<h2><?php echo e($data['quotation']->tendor->user->business_name); ?></h2>
							...
							<form id="quotation-form" method="post" action="<?php echo e(route('supplier.quotation.update',$data['quotation']->id)); ?>">
								<?php echo csrf_field(); ?>
								<?php echo e(method_field('PUT')); ?>

								<input type="hidden" name="tendor_id" value="<?php echo e($data['quotation']->tendor_id); ?>">
								<!--Data table-->
												...
												<table class="table">
													...
													<tbody>
														...
														<tr>
															...
															<td><?php echo e($product->product->qty); ?></td>
															<td>
																<div class="price">
																	<span><?php echo e($data['quotation']->tendor->currency); ?></span>
																	<input class="p-price" type="text" value="<?php echo e($product->price); ?>" pattern="[+-]?([0-9]*[.])?[0-9]+" name="price[]">
																</div>
															 </td>
															<td>
															    <div class="qty">
																	<input type="hidden" name="unit[]" value="<?php echo e($product->unit); ?>">														
																	<input class="p-qty" oninput="this.value=this.value.replace(/[^0-9]/g,'');" type="text" value="<?php echo e($product->qty); ?>" name="qty[]">
																</div>
															</td>
															<?php $totalEstimatePrice += $product->qty*$product->price ?>
															<td> <?php echo e($data['quotation']->tendor->currency); ?> <span class="p-sub-total"><?php echo e($product->qty*$product->price); ?></span>
															    <input type="hidden" class="sub-total" name="sub-total[]" value="<?php echo e($product->qty*$product->price); ?>">
															</td>
														</tr> <!--end-->
													    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
													</tbody>
													...
													<tfoot>
														<tr>
															...
															<td class="gray-bg">
																<?php echo e($data['quotation']->currency); ?> <span class="p-sub-total" id="estimated-total"><?php echo e($totalEstimatePrice); ?></span>
															</td>
														</tr>
														<tr>
															<td></td>
																...
																<div class="choose-tax">
																	<select name="tax">
																		...
																		<?php $__currentLoopData = $data['taxes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																		      <option <?php if($data['quotation']->tax->id == $tax->id): ?> selected <?php endif; ?> data-value="<?php echo e($tax->tax); ?>" value="<?php echo e($tax->id); ?>"><?php echo e($tax->title); ?> (<?php echo e($tax->tax); ?>%)</option>
																		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
																	</select>
																</div>
															</td>
														...
														<tr>
															...
															<td>
																<div class="order-status" style="width:100px;">
																	<div class="lead-time">
																		...
																		<label>Day</label>
																		<input type="text" oninput="this.value=this.value.replace(/[^0-9]/g,'');" value="<?php echo e($data['quotation']->lead_day); ?>" name="lead_day">
																	</div>
																</div>
															</td>
															<td></td>
															...
															<td class="gray-bg"><?php echo e($data['quotation']->tendor->currency); ?> <span id="grand-total"><?php echo e($totalPrice); ?></span></td>
														</tr>
												...
												<tr>
													<td>
														...
														<span>Cancel Reason*</span>
															...
															<div class="col-md-6 col-sm-6 col-xs-12">
															<span>	Cancel By
															<?php if($data['quotation']->cancel_user_id != auth::id()): ?> Vendor <?php else: ?> You <?php endif; ?>
															</span>
															</div>
  ...
  <div class="modal fade" id="cancelQuotationModal" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
         <form action="<?php echo e(route('supplier.quotation.cancel',$data['quotation']->id)); ?>" method="post" id="cancelModalForm">
        	<?php echo csrf_field(); ?>
            <?php echo e(method_field('PUT')); ?>
