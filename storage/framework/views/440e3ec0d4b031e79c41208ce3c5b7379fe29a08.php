						...
						<form method="GET">
							<div class="row">
								...
								<div class="col-md-3 col-sm-3 col-xs-3">
									<div class="filter-btn">
										<a class="button" href="<?php echo e(route('vendor.order.index')); ?>">Clear</a>
							...
							<div class="row">
								<?php $__currentLoopData = $data['orders']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<a href="<?php echo e(route('vendor.order.show',$order->id)); ?>">
											<div class="single-tender">
											<div class="heading">
												<p><i class="far fa-calendar-alt"></i> <span>Order Date</span><?php echo e(date('d-M-Y',strtotime($order->created_at))); ?></p>
											</div>
