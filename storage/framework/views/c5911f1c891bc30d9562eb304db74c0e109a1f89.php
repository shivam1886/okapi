<?php $__env->startSection('content'); ?>
					...
					<div class="inner-body">
						...
						<div class="header">
							<div class="row">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="text">
										<a href="<?php echo e(route('vendor.order.pdf',$data['order']->id)); ?>" class="download-pdf"><i class="fas fa-download"></i> Download PDF</a>
						...
						<div class="tender-details quatation-details my-orders">
							...
							<div class="product-details">
								...
								<div class="img-text clearfix">
									<div class="img">
										<img onerror="profileImgError(this)" src="<?php echo e($data['order']->supplier->profile_image); ?>">
									</div>
									<div class="txt">
										<h2><?php echo e($data['order']->supplier->business_name); ?></h2>
										<p><i class="fas fa-map-marker-alt"></i>  <?php echo e($data['order']->supplier->address); ?></p>
									</div>
								</div>	
															...
															<div class="order-status status-btn">
																<div class="choose-tax">
																	<span>Order Status</span>
																	 <select class="custome-order-status" readonly>
																		...
																		<option <?php if($data['order']->status == '5'): ?> selected <?php endif; ?> value="5">Received</option>
																	</select>
																</div>

																<?php if($data['order']->status == '2'): ?>
																<button data-url="<?php echo e(route('supplier.received.order',$data['order']->id)); ?>" class="received-product save" style="background: #01c84d" data-url="<?php echo e(route('vendor.cancel.order',$data['order']->id)); ?>">Received</button>
																<?php endif; ?>
  ...
  <div class="modal fade" id="cancelOrderModal" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
         <form action="<?php echo e(route('vendor.cancel.order',$data['order']->id)); ?>" method="post" id="cancelOrderForm">
        	<?php echo csrf_field(); ?>
...
<?php $__env->startPush('js'); ?>
 <script type="text/javascript">
  	 ...
  	 $('body').on('submit','#cancelOrderForm',function(e){
  	   ...
  	   $('body').on('click','.received-product',function(e){
  	  	    e.preventDefault();
  	  	     swal({
		  title: "Are you sure?",
