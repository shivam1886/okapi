							...
							<div class="row">
								...
								<div class="col-md-6 col-sm-6 col-xs-6">
									<div class="filter-btn">
										<a class="button" href="<?php echo e(route('supplier.my.vendor')); ?>">Clear</a>
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="single-s-request">
										...
										<div class="buttons txt">
                                           <button class="remove-btn remove" data-url="<?php echo e(route('supplier.vendor.remove',$vendor->id)); ?>">Remove</button>
                                           <a href="<?php echo e(route('supplier.my.vendor.details',$vendor->id)); ?>">Details</a>
										</div>
									</div>
