								...
								<div class="col-md-7 col-sm-7 col-xs-12">
									<div class="profile-details">
										<div class="profile-star clearfix">
											...
											<div class="star">
												<?php if($data['vendor']->is_request): ?>
												  <button class="cancel-request-btn remove" data-url="<?php echo e(route('supplier.cancel.request',$data['vendor']->id)); ?>">Cancel Request</button>
												<?php else: ?>
												  <button class="request-btn" data-url="<?php echo e(route('supplier.vendor.request',$data['vendor']->id)); ?>">Request</button>
												<?php endif; ?>
											</div>
										</div>
