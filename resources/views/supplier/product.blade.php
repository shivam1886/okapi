							...
							<div class="row">
								<div class="col-md-6 col-sm-6 col-xs-6">
									<div class="row">
										<div class="col-md-12">
											<div class="input">
												<input type="text" placeholder="Search by product name" name="search" value="{{Request::get('search')}}">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-md-6 col-sm-6 col-xs-6">
									<div class="filter-btn">
										<a class="button" href="{{route('supplier.product.index')}}">Clear</a>
					    ...
					    <div class="modal-dialog modal-md">
					      ...
					      <div class="modal-content">
					        ...
					        <div class="modal-body">
					          <form action="{{route('supplier.product.store')}}" method="post" id="addProductForm">
					          	@csrf
					  ...
					  <div class="modal fade add-product-modal" id="editProductModal" role="dialog">
					    <div class="modal-dialog modal-md">
					      ...
					      <div class="modal-content">
					        ...
					        <div class="modal-body">
					          <form action="{{route('supplier.product.update')}}" method="post" id="updateProductForm">
					          	@csrf
					          	{{method_field('PUT')}}
  	    	...
  	    	$.ajax(
					{
						...
						'type':'get',
						'url' : "{{route('supplier.product.edit')}}",
						'data' : data,
					beforeSend: function() {
