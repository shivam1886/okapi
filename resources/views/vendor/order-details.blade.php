					...
					<div class="inner-body">
						...
						<div class="header">
							<div class="row">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="text">
										<a href="{{route('vendor.order.pdf',$data['order']->id)}}" class="download-pdf"><i class="fas fa-download"></i> Download PDF</a>
						...
						<div class="tender-details quatation-details my-orders">
							...
							<div class="product-details">
								...
								<div class="img-text clearfix">
									<div class="img">
										<img onerror="profileImgError(this)" src="{{$data['order']->supplier->profile_image}}">
									</div>
									<div class="txt">
										<h2>{{$data['order']->supplier->business_name}}</h2>
															...
															<div class="order-status status-btn">
																<div class="choose-tax">
																	<span>Order Status</span>
																	 <select class="custome-order-status" disabled>
																		...
																		<option @if($data['order']->status == '5') selected @endif value="5">Received</option>
																	</select>
																</div>

																@if($data['order']->status == '2')
																<button data-url="{{route('supplier.received.order',$data['order']->id)}}" class="received-product save" style="background: #01c84d" data-url="{{route('vendor.cancel.order',$data['order']->id)}}">Received</button>
																@endif
